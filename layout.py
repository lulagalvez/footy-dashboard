...
def create_layout(teams):
    ...
    return html.Div([
        ...
        html.Div(
            ...
            style={'width': '20%', 'margin-left': 35, 'margin-right': 35, 'margin-top': 35, 'margin-bottom': 35}
        ),
        html.Div(
            [
                # Gráficos 
                html.Div([
                    html.Div(dcc.Graph(id='graph-1'), className='graph-square', style={'height': '50%', 'width': '100%'}),
                ]),
                html.Div([
                    html.Div(dcc.Graph(id='graph-2'), className='graph-square', style={'height': '50%', 'width': '100%'}),
                ]),
                html.Div([
                    html.Div(dcc.Graph(id='graph-3'), className='graph-square', style={'height': '50%', 'width': '100%'}),
                ]),
                html.Div([
                    html.Div(dcc.Graph(id='graph-4'), className='graph-square', style={'height': '50%', 'width': '100%'}),
                ])
            ],
